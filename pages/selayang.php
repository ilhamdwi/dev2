...
*/
$rel_path = 'images/Profil Sultan Hasanuddin Pahlawan Indonesia Poster Pendidikan Hijau dan Krem Ilustratif Sederhana(1).png';
...
<section class="page-head py-4">
  <div class="container container-narrow">
    <h1 class="mb-1">SELAYANG PANDANG</h1>
