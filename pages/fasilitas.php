...
$rel_paths = [
  ['path' => 'img/fasilitas.png', 'caption' => 'Fasilitas Di SMAI PB Soedirman 2 Bekasi'],
  ['path' => 'img/gerbang.jpeg', 'caption' => 'Gerbang Masuk Sekolah'],
  ['path' => 'img/kolam.png', 'caption' => 'Kolam Ikan'],
  ['path' => 'img/lapangan.png', 'caption' => 'Lapangan Sekolah'],
  ['path' => 'img/Gedung SMA 2022.JPEG', 'caption' => 'Gedung Sekolah'],
];
...
<section class="page-head py-4">
  <div class="container container-narrow">
    <h1 class="mb-1">Fasilitas SMAI PB Soedirman 2 Bekasi</h1>
  </div>
</section>
