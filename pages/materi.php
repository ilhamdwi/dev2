...
$deskripsi_web = $deskripsi_web ?? 'Materi Pembelajaran Agama Islam';
$keyword_web   = $keyword_web   ?? 'materi PAIS, sholat, doa, Al-Quran, sholat sunnah';
$admin_web     = $admin_web     ?? 'Admin';

/* ========= Daftar Foto Materi PAIS (ubah sesuai file Anda) ========= */
$rel_paths = [
  ['path' => 'img/1.png', 'caption' => '10 Bacaan Sholat'],
  ['path' => 'img/2.png', 'caption' => '10 Bacaan Sholat'],
  ['path' => 'img/3.png', 'caption' => '10 Bacaan Sholat'],
  ['path' => 'img/4.png', 'caption' => '10 Bacaan Sholat'],
  ['path' => 'img/5.png', 'caption' => '10 Bacaan Sholat'],
  ['path' => 'img/6.png', 'caption' => 'Bacaan Doa Setelah Sholat 5 Waktu'],
  ['path' => 'img/7.png', 'caption' => 'Bacaan Doa Setelah Sholat 5 Waktu'],
  ['path' => 'img/8.png', 'caption' => 'Bacaan Doa Setelah Sholat 5 Waktu'],
  ['path' => 'img/9.png', 'caption' => 'Bacaan Doa Setelah Sholat 5 Waktu'],
  ['path' => 'img/10.png', 'caption' => '15 Cara Menghafal Bacaan Al-Quran'],
  ['path' => 'img/11.png', 'caption' => '15 Cara Menghafal Bacaan Al-Quran'],
  ['path' => 'img/12.png', 'caption' => '15 Cara Menghafal Bacaan Al-Quran'],
  ['path' => 'img/13.png', 'caption' => 'Macam Macam Sholat Sunnah'],
  ['path' => 'img/14.png', 'caption' => 'Macam Macam Sholat Sunnah'],
  ['path' => 'img/15.png', 'caption' => 'Macam Macam Sholat Sunnah'],
];
...
<title>NEW <?php echo htmlspecialchars($title_web, ENT_QUOTES); ?> — Materi PAIS</title>
...
<style>
  ...
  .poster-card{
    ...
    /* Mengatur lebar maksimum kartu poster dan memusatkannya */
    max-width: 600px; /* Sesuaikan nilai ini */
    margin-left: auto;
    margin-right: auto;
  }
  ...
  .poster-img{
    width:100%;
    height:auto; /* Sangat penting untuk menjaga aspek rasio */
    display:block;
  }
  ...
  @media (min-width: 768px) {
    .stack-gap {
      ...
      grid-template-columns: repeat(2, 1fr); /* 2 kolom untuk tablet ke atas */
      gap: 1.5rem; /* Jarak antar kolom */
    }
    .poster-card {
      max-width: none; /* Izinkan kartu melebar sesuai kolom grid */
      margin: 0; /* Hapus margin auto jika dalam grid */
    }
  }
  @media (min-width: 992px) {
    .stack-gap {
      grid-template-columns: repeat(3, 1fr); /* 3 kolom untuk desktop ke atas */
    }
  }
  #whatsapp-btn {
    position: fixed;
