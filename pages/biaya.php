...
$rel_paths = [
  ['path' => 'img/biaya.png', 'caption' => 'Biaya Pendidikan SMAI PB Soedirman 2 Bekasi'],
];
...
<section class="page-head py-4">
  <div class="container container-narrow">
    <h1 class="mb-1">Info Biaya Sekolah SMAI PB Soedirman 2 Bekasi</h1>
  </div>
</section>
...
<section class="py-4" style="background: #fdfdfd;"> <div class="container container-narrow">
    ...
    <div class="ppdb-info">
      <h2 class="h4 mb-3">Informasi Biaya Pendidikan di SMAI PB Soedirman 2 Bekasi</h2>
      <p>
        <br>
        Berikut kami sampaikan untuk biaya pendidikan di SMAI PB Soedirman 2 Bekasi
        </br>
      </p>
    </div>
