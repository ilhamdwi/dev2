...
$rel_paths = [
  ['path' => 'img/mars.png', 'caption' => 'MARS KELUARGA BESAR YASMA PB SOEDIRMAN'],
];
...
<section class="page-head py-4">
  <div class="container container-narrow">
    <h1 class="mb-1">MARS YASMA PB SOEDIRMAN </h1>
  </div>
</section>
...
<section class="py-4" style="background: #fdfdfd;"> <div class="container container-narrow">
    ...
    <div class="ppdb-info">
      <h2 class="h4 mb-3">Lirik MARS YASMA PB SOEDIRMAN</h2>
      <p>
        <br>
        Assalamualaikum Wr Wb
        Mari anak-anak kita pahami dan hafalkan Mars Yasma PB Soedirman
        Perhatikan liriknya di bawah ini. Kamu juga bisa memutar videonya 
        <a href="https://www.youtube.com/watch?v=G6ypEtcKwTU" target="_blank" rel="noopener noreferrer">
          disini
        </a>
      </p>
    </div>
