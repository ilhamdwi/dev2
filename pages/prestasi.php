...
$rel_paths = [
  ['path' => 'img/lombadebat.png', 'caption' => 'Lomba Debat Se JaBoDeTaBek'],
  ['path' => 'img/story telling1.png', 'caption' => 'Lomba Story Telling'],
  ['path' => 'img/debat.jpeg', 'caption' => 'Lomba Debat Juara 1 Tingkat Provinsi'],
  ['path' => 'img/silat.jpeg', 'caption' => 'Juara Piala Kemenpora'],
  ['path' => 'img/futsal.jpg', 'caption' => 'Kejuaraan Antar Pelajar Jakarta-Bekasi'],
];
...
<section class="page-head py-4">
  <div class="container container-narrow">
    <h1 class="mb-1">Prestasi SMAI PB Soedirman 2</h1>
  </div>
</section>
